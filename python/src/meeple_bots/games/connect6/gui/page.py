  ...
  <script>
    ...
    function updateAgentFields() {
      for (const player of [0, 1]) {
        ...
        document.querySelector(`#exploration-${player}`).disabled=document.querySelector(`#selection-policy-${player}`).value==='ucb1_tuned';
      }
    }
